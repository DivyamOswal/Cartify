      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <nav className="flex items-center gap-2 text-sm text-app-text-light mb-6">
          ...
          <span className="text-app-green font-medium">
            {activeCatergory ? activeCatergory.name : "All Products"}
          </span>
        </nav>
        <div className="flex gap-8 xl:gap-10">
          ...
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="bg-white rounded-2xl p-4 sticky top-24 max-h-[calc(100vh-7rem)] overflow-y-auto">
              <FilterPanel
          ...
          <main className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <button
                  ...
                  className="lg:hidden flex items-center gap-2 px-3 py-2 text-sm bg-white rounded-xl border border-app-border hover:bg-app-cream transition-all"
                >
            ...
            {loading ? (
              ...
              <div className="text-center py-16">
                <p className="text-lg font-semibold text-appgreen mb-2">
                  No products found
                </p>
