  ...
  return (
    <div className="min-h-screen mb-20 bg-app-cream">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <button onClick={()=> navigate("/orders")} className="flex items-center gap-2 texts-sm text-app-text-light hover:text-app-green mb-6 transition-colors">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5">
              <h3 className="text-sm font-semibold text-app-green mb-3 flex items-center gap-2">
                <MapPinIcon className="szie-4"/>
                Delivery Address
              </h3>
              <p className="text-sm text-lapp-text-light leading-relaxed">{order?.shippingAddress.label}
                <br />
                ...
                {order?.items.map((item, i)=>(
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-app-text-light">{item.quantity}</p>
                    </div>
